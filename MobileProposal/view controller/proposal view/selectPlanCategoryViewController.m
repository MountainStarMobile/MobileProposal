//
//  selectPlanCategoryViewController.m
//  MobileProposal
//
...
@interface selectPlanCategoryViewController ()

@end

@implementation selectPlanCategoryViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (row == 0)
    {
        [cell.textLabel setText:[[switchFunction switchFunctionInstance] GetPlanCategoryNameWithKey:planCategoryMain]];
    }
    else if (row == 1)
    {
        [cell.textLabel setText:[[switchFunction switchFunctionInstance] GetPlanCategoryNameWithKey:planCategoryElse]];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    [self dismissViewControllerAnimated:YES completion:^{
        NSUInteger row = [indexPath row];
        [delegate didSelectPlanCategory:row];
    }];
}
