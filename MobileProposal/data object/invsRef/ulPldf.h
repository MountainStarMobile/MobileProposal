...
@interface ulPldf : NSObject
{
    ...
    NSString *ratingInd;
    NSString *iRateRaiseInd;
    NSString *iRateRaisePtr;
    NSString *cpiOption;
    NSString *cpiInterval;
    NSString *cpiRate;
    NSString *planType;
...
@property (nonatomic, retain) NSString *iRateRaiseInd;
@property (nonatomic, retain) NSString *iRateRaisePtr;
@property (nonatomic, retain) NSString *cpiOption;
@property (nonatomic, retain) NSString *cpiInterval;
@property (nonatomic, retain) NSString *cpiRate;
